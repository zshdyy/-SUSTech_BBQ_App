...
public class qingzhencaiFragment extends Fragment {
    ...
    private final int[] infos = {
            R.string.qingzhen1, R.string.qingzhen2, R.string.qingzhen3, R.string.qingzhen4,
            R.string.qingzhen5, R.string.qingzhen6, R.string.qingzhen7, R.string.qingzhen8,
            R.string.qingzhen9, R.string.qingzhen10, R.string.qingzhen11, R.string.qingzhen12
    };
    public qingzhencaiFragment() {
        // 必需的空公共构造函数
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvZhushiCai = view.findViewById(R.id.qingzhencai);
