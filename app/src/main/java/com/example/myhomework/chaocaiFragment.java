...
public class chaocaiFragment extends Fragment {
    ...
    private final int[] infos = {R.string.shaokao1, R.string.shaokao2, R.string.shaokao3, R.string.shaokao4,
            R.string.shaokao5, R.string.shaokao6, R.string.shaokao7, R.string.shaokao8,
            R.string.shaokao9, R.string.shaokao10, R.string.shaokao11, R.string.shaokao12};
    public chaocaiFragment() {
        // 必需的空公共构造函数
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvZhushiCai = view.findViewById(R.id.chaocaicai);
